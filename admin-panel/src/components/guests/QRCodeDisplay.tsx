      ...
      <div className="text-center">
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
          ...
          <ul className="text-xs text-blue-700 space-y-1 text-left">
            <li>• Print the QR code and place it at the camp entrance</li>
            <li>• Guests can scan the code with their smartphone camera</li>
            <li>• They will be automatically redirected to the registration page</li>
            <li>• After registration, they appear immediately in the guest list</li>
          </ul>
        </div>
      </div>
    </div>
